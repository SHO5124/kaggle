...
if __name__ == '__main__':
    ...
    parser.add_argument("--path", help="path to files", type=str, default='/Users/satosho/Desktop/kaggle/Understanding-Clouds-from-Satellite-Images-master/kaggle/Understanding-Clouds-from-Satellite-Images-master/data')
